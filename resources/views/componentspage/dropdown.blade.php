                    ...
                    <div class="">
                        ...
                        <div id="defaultActionPill" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-2xl w-44">
                            <ul class="py-2 text-base text-gray-700">
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">Action</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">Primary Action</a>
                                </li>
                                <li>
                    ...
                    <div class="">
                        ...
                        <div id="defaultActionPillDropRight" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-2xl w-44">
                            <ul class="py-2 text-base text-gray-700">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">warning Action</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">Something Else</a>
                                </li>
                    ...
                    <div class="">
                        ...
                        <div id="defaultActionPillDropPlacement" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-2xl w-44">
                            <ul class="py-2 text-base text-gray-700">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">success Action</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="block px-4 py-2 hover:bg-gray-100">Something Else</a>
                                </li>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="">
                        <div class="flex">
                            ...
                            <button class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium text-base px-5 py-4 text-center inline-flex items-center" type="button">
                                2
                            </button>
                            <button data-dropdown-toggle="defaultActionPillDropGroup" data-dropdown-placement="bottom" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-e-lg text-base px-5 py-4 text-center inline-flex items-center" type="button">
                                Default Action
                                <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <div class="">
                        <div class="flex">
                            ...
                            <button class="hover:bg-warning-600 border border-x-0 hover:text-white border-warning-600 text-warning-600  focus:ring-4 focus:outline-none focus:ring-warning-300 font-medium text-base px-5 py-4 text-center inline-flex items-center" type="button">
                                2
                            </button>
                            <button data-dropdown-toggle="outlineActionPillDropGroup" data-dropdown-placement="bottom" class="hover:bg-warning-600 border hover:text-white border-warning-600 text-warning-600  focus:ring-4 focus:outline-none focus:ring-warning-300 font-medium rounded-e-lg text-base px-5 py-4 text-center inline-flex items-center" type="button">
                                Default Action
                                <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"></path>
                                </svg>
