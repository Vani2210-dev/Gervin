    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body py-4 px-6">
                    <h1 class="text-primary-600 mb-4 leading-[60px]">Heading 1</h1>
                    <h2 class="text-success-600 mb-4 leading-[60px]">Heading 2</h2>
                    <h3 class="text-warning-600 mb-4 leading-[60px]">Heading 3</h3>
                    <h4 class="text-danger-600 mb-4">Heading 4</h4>
                    <h5 class="text-info-600 mb-4">Heading 5</h5>
                    <h6 class="text-neutral-500">Heading 6</h6>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body py-4 px-6">
                    <p class="mb-4 text-secondary-light font-normal">You can use the mark tag to <span class="text-warning-600 bg-warning-100 px-1.5">highlight</span> text</p>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body py-4 px-6">
                    ...
                    <p class="mb-4 text-neutral-600 font-normal underline">This text has a line underneath it.</p>
                    <p class="mb-4 text-neutral-600 font-normal line-through">This text has a line going through it.</p>
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="p-4 bg-info-50 rounded-lg border-l-[3px] border-info border-info-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-info-600 mb-0">- WowDash</span>
                        </div>
                        <div class="p-4 bg-success-50 rounded-lg border-l-[3px] border-success-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-success-600 mb-0">- WowDash</span>
                        </div>
                        <div class="p-4 bg-info-50 rounded-lg border-l-[3px] border-info-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-info-600 mb-0">- WowDash</span>
                        </div>
                        <div class="p-4 bg-danger-50 rounded-lg border-l-[3px] border-danger-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-danger-600 mb-0">- WowDash</span>
                        </div>
                        <div class="p-4 bg-warning-50 rounded-lg border-l-[3px] border-warning-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-warning-600 mb-0">- WowDash</span>
                        </div>
                        <div class="p-4 bg-neutral-50 rounded-lg border-l-[3px] border-neutral-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-neutral-600 mb-0">- WowDash</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="p-4 bg-transparent rounded-lg border border-start-width-3-px border-cyan-600">
                            <h6 class="text-neutral-600 text-base mb-2">Custom Blockquote Primary Example</h6>
                            <span class="text-cyan-600 mb-0">- WowDash</span>
                        </div>
