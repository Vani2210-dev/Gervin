    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div class="col-span-1 lg:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6 flex flex-col gap-4">
                    <div class="alert alert-primary bg-primary-50 text-primary-600 border-primary-50 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                    ...
                    <div class="alert alert-purple bg-purple-100 text-purple-600 border-purple-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                    ...
                    <div class="alert alert-warning bg-warning-100 text-warning-600 border-warning-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                    ...
                    <div class="alert alert-info bg-info-100 text-info-600 border-info-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                    ...
                    <div class="alert alert-danger bg-danger-100 text-danger-600 border-danger-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
        ...
        <div class="col-span-1 lg:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6 flex flex-col gap-4">
                    ...
                    <div class="alert alert-purple bg-transparent border border-purple-600 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                        This is a Secondary alert
                        <button class="remove-button text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                    </div>
        ...
        <div class="col-span-1 lg:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6 flex flex-col gap-4">
                    <div class="alert alert-primary bg-primary-100 text-primary-600 border-primary-50 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                    ...
                    <div class="alert alert-purple bg-purple-100 text-purple-600 border-purple-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                        ...
                        <button class="remove-button text-purple-600 text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                    </div>
                    <div class="alert alert-success bg-success-100 text-success-600 border-success-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
        ...
        <div class="col-span-1 lg:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6 flex flex-col gap-4">
                    <div class="alert alert-primary bg-primary-100 text-primary-600 border-start-width-4-px border-l-[3px] border-neutral-200 px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="mingcute:emoji-line" class="icon text-xl"></iconify-icon>
                            This is a Primary alert
                        </div>
                    ...
                    <div class="alert alert-purple bg-purple-100 text-purple-600 border-purple-600 border-start-width-4-px border-l-[3px] px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="mingcute:emoji-line" class="icon text-xl"></iconify-icon>
                            This is a Secondary alert
                        </div>
                    ...
                    <div class="alert alert-success bg-success-100 text-success-600 border-success-600 border-start-width-4-px border-l-[3px] px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="akar-icons:double-check" class="icon text-xl"></iconify-icon>
                            This is a Success alert
                        </div>
                    ...
                    <div class="alert alert-warning bg-warning-100 text-warning-600 border-warning-600 border-start-width-4-px border-l-[3px] px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="mdi:alert-circle-outline" class="icon text-xl"></iconify-icon>
                            This is a Warning alert
                        </div>
                    ...
                    <div class="alert alert-info bg-info-100 text-info-600 border-info-600 border-start-width-4-px border-l-[3px] px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="ci:link" class="icon text-xl"></iconify-icon>
                            This is a Info alert
                        </div>
                    ...
                    <div class="alert alert-danger bg-danger-100 text-danger-600 border-danger-600 border-start-width-4-px border-l-[3px] px-6 py-[13px] mb-0 font-semibold text-lg rounded flex items-center justify-between" role="alert">
                        <div class="flex items-center gap-2">
                            <iconify-icon icon="mingcute:delete-2-line" class="icon text-xl"></iconify-icon>
                            This is a Danger alert
                        </div>
        ...
        <div class="col-span-1 lg:col-span-6">
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6 flex flex-col gap-4">
                    <div class="alert alert-primary bg-primary-100 text-primary-600 border-primary-50 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg" role="alert">
                    ...
                    <div class="alert alert-success bg-success-100 text-success-600 border-success-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg" role="alert">
                        <div class="flex items-center justify-between text-lg">
                            This is a Success alert
                            <button class="remove-button text-success-600 text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                        </div>
                    ...
                    <div class="alert alert-warning bg-warning-100 text-warning-600 border-warning-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg" role="alert">
                        <div class="flex items-center justify-between text-lg">
                            This is a Warning alert
                            <button class="remove-button text-warning-600 text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                        </div>
                    ...
                    <div class="alert alert-info bg-info-100 text-info-600 border-info-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg" role="alert">
                        <div class="flex items-center justify-between text-lg">
                            This is a Info alert
                            <button class="remove-button text-info-600 text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                        </div>
                    ...
                    <div class="alert alert-danger bg-danger-100 text-danger-600 border-danger-100 px-6 py-[11px] mb-0 font-semibold text-lg rounded-lg" role="alert">
                        <div class="flex items-center justify-between text-lg">
                            This is a Danger alert
                            <button class="remove-button text-danger-600 text-2xl line-height-1"> <iconify-icon icon="iconamoon:sign-times-light" class="icon"></iconify-icon></button>
                        </div>
