...
@section('content')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div class="card h-full rounded-xl overflow-hidden border-0">
                        ...
                        <div class="card-body p-4">
                            <h5 class="card-title text-lg text-neutral-600
                        mb-1.5">
                                This is Card title
                            </h5>
                    ...
                    <div class="card h-full rounded-xl overflow-hidden border-0">
                        ...
                        mb-1.5">
                            ...
                            <div class="flex flex-wrap items-center justify-end gap-3">
                                <a href="javascript:void(0)" class="btn btn-primary-100 bg-primary-100 hover:bg-primary-600 hover:text-white text-primary-600 px-3 py-2.5 inline-flex items-center gap-2">
                                    Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
                                </a>
                                <button class="btn btn-warning-100 bg-warning-100 hover:bg-warning-600 hover:text-white text-warning-600 px-3 py-2.5 inline-flex items-center gap-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div class="card h-full rounded-xl overflow-hidden border-0">
                        <div class="card-body p-6">
                            <div class="w-[64px] h-[64px] inline-flex items-center justify-center bg-purple-200 text-purple-600 mb-4 rounded-xl">
                            ...
                            <a href="javascript:void(0)" class="btn text-purple-600 hover:underline px-0 py-0 mt-4 inline-flex items-center gap-2">
                                Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
                            </a>
                        </div>
                    </div>
                    <div class="card h-full rounded-xl overflow-hidden border-0 text-center">
                        <div class="card-body p-6">
                            <div class="w-[64px] h-[64px] inline-flex items-center justify-center bg-primary-100 text-primary-600 mb-4 rounded-xl">
                    ...
                    <div class="card h-full rounded-xl overflow-hidden border-0 text-end">
                        <div class="card-body p-6">
                            <div class="w-[64px] h-[64px] inline-flex items-center justify-center bg-success-100 text-success-600 mb-4 rounded-xl">
                    ...
                    <div class="card h-full rounded-xl overflow-hidden border-0 text-center">
                        <div class="card-body p-6">
                            <div class="w-[64px] h-[64px] inline-flex items-center justify-center bg-danger-100 text-danger-600 mb-4 rounded-xl">
                    ...
                    <div class="card h-full rounded-xl p-0 border-0 overflow-hidden relative">
                        <div class="card-body p-0 before:block before:absolute before:inset-0 before:bg-[linear-gradient(180deg,_rgba(0,_0,_0,_0)_0%,_rgba(0,_0,_0,_0.25)_22%,_rgba(0,_0,_0,_0.69)_57.92%,_rgba(0,_0,_0,_0.7)_100%)] bottom-0 start-0">
                            ...
                            <div class="absolute start-0 bottom-0 p-6 z-1">
                                <h5 class="card-title text-white text-lg mb-1.5">This is Card title</h5>
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-3 gap-6">
                    <div class="card rounded-xl h-full border-0 overflow-hidden">
                        <div class="card-header py-4 px-6 bg-white flex items-center gap-1 justify-between border-b">
                        ...
                        <div class="card-body py-4 px-6">
                            <h6 class="card-title text-neutral-600 mb-2 text-lg">How to learn UI /UX Design</h6>
                        ...
                        <div class="card-footer text-center bg-transparent border-t border-neutral-200 pt-4 px-6">
                            <a href="javascript:void(0)" class="text-primary-600 hover:underline">View All</a>
                        </div>
                    </div>
                    <div class="card rounded-xl h-full border-0 overflow-hidden">
                        <div class="card-body py-4 px-6">
                            ...
                            <a href="javascript:void(0)" class="btn text-primary-600 hover:underline hover-text-primary px-0 py-0 inline-flex items-center gap-2 mt-4">
                                Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
                            </a>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    <div class="card rounded-xl overflow-hidden border-0 flex flex-nowrap sm:flex-row flex-col">
                        ...
                        <div class="card-body p-4 grow">
                            <h5 class="card-title text-lg text-neutral-900 mb-1.5">This is Card title</h5>
                            <p class="card-text text-neutral-600 mb-4">We quickly learn to fear and thus automatically avo id potentially stressful situations of all kinds, including the most common of all .</p>
            ...
            <div class="">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div class="card h-full rounded-xl border-0 overflow-hidden bg-purple-100">
                        <div class="card-body p-6">
                    ...
                    <div class="card h-full rounded-xl border-0 overflow-hidden bg-primary-100 text-center">
                        <div class="card-body p-6">
                    ...
                    <div class="card h-full rounded-xl border-0 overflow-hidden bg-success-100 text-end">
                        <div class="card-body p-6">
                    ...
                    <div class="card h-full rounded-xl border-0 overflow-hidden bg-danger-100 text-center">
                        <div class="card-body p-6">
