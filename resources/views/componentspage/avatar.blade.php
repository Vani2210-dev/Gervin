    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap gap-3">
                        <span class="w-6 h-6 rounded-full object-fit-cover flex justify-center items-center font-semibold text-[10px] bg-primary-100 text-primary-600">24</span>
                        <span class="w-8 h-8 rounded-full object-fit-cover flex justify-center items-center font-semibold text-xs bg-purple-100 text-purple-600">32</span>
                        <span class="w-10 h-10 rounded-full object-fit-cover flex justify-center items-center font-semibold text-sm bg-success-100 text-success-600">40</span>
                        <span class="w-[44px] h-[44px] rounded-full object-fit-cover flex justify-center items-center font-semibold text-base bg-info-100 text-info-600">44</span>
                        <span class="w-[56px] h-[56px] rounded-full object-fit-cover flex justify-center items-center font-semibold text-lg bg-warning-100 text-warning-600">56</span>
                        <span class="w-[64px] h-[64px] rounded-full object-fit-cover flex justify-center items-center font-semibold text-xl bg-danger-100 text-danger-600">64</span>
                    </div>
                    <div class="flex items-center flex-wrap gap-3 mt-6">
                        <span class="w-6 h-6 rounded object-fit-cover flex justify-center items-center font-semibold text-[10px] bg-primary-100 text-primary-600">24</span>
                        <span class="w-8 h-8 rounded-lg object-fit-cover flex justify-center items-center font-semibold text-xs bg-purple-100 text-purple-600">32</span>
                        <span class="w-10 h-10 rounded-lg object-fit-cover flex justify-center items-center font-semibold text-sm bg-success-100 text-success-600">40</span>
                        <span class="w-[44px] h-[44px] rounded-lg object-fit-cover flex justify-center items-center font-semibold text-base bg-info-100 text-info-600">44</span>
                        <span class="w-[56px] h-[56px] rounded-lg object-fit-cover flex justify-center items-center font-semibold text-lg bg-warning-100 text-warning-600">56</span>
                        <span class="w-[64px] h-[64px] rounded-lg object-fit-cover flex justify-center items-center font-semibold text-xl bg-danger-100 text-danger-600">64</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0 h-full">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="flex items-center flex-wrap gap-3 mt-6">
                        ...
                        <div class="relative">
                            <span class="w-8 h-8 rounded-full object-fit-cover flex justify-center items-center font-semibold text-[10px] bg-purple-100 text-purple-600">24</span>
                            <span class="w-2 h-2 bg-purple-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                        <div class="relative">
                            <span class="w-10 h-10 rounded-full object-fit-cover flex justify-center items-center font-semibold text-[10px] bg-success-100 text-success-600">24</span>
                            <span class="w-2 h-2 bg-success-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                        <div class="relative">
                            <span class="w-[44px] h-[44px] rounded-full object-fit-cover flex justify-center items-center font-semibold text-[10px] bg-info-100 text-info-600">24</span>
            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0 h-full">
                ...
                <div class="card-body p-6">
                    <div class="flex -space-x-2 overflow-hidden">
                        ...
                        <img src="{{ asset('assets/images/avatar/avatar-group6.png') }}" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <span class="w-6 h-6 rounded-full object-fit-cover relative ms--10px border bg-neutral-100 text-neutral-600 text-xs inline-flex items-center justify-center">
                            +5
                        </span>
                    ...
                    <div class="flex -space-x-2 overflow-hidden mt-6">
                        ...
                        <img src="{{ asset('assets/images/avatar/avatar-group6.png') }}" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <span class="w-8 h-8 rounded-full object-fit-cover relative ms--10px border bg-neutral-100 text-neutral-600 text-xs inline-flex items-center justify-center">
                            +5
                        </span>
