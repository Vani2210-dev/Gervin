    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="badge text-sm font-semibold bg-light-600 px-5 py-1.5 rounded text-dark">Light</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="badge text-sm font-semibold border border-purple-600 bg-transparent px-5 py-1.5 rounded">Secondary</span>
        ...
        <div>
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        <span class="badge text-sm font-semibold text-primary-600 bg-primary-100 px-5 py-1.5 rounded">Primary</span>
                        <span class="badge text-sm font-semibold text-purple-600 bg-purple-100 px-5 py-1.5 rounded">Secondary</span>
                        <span class="badge text-sm font-semibold text-success-600 bg-success-100 px-5 py-1.5 rounded">Success</span>
                        <span class="badge text-sm font-semibold text-info-600 bg-info-100 px-5 py-1.5 rounded">Info</span>
                        <span class="badge text-sm font-semibold text-warning-600 bg-warning-100 px-5 py-1.5 rounded">Warning</span>
                        <span class="badge text-sm font-semibold text-danger-600 bg-danger-100 px-5 py-1.5 rounded">Danger</span>
                        <span class="badge text-sm font-semibold text-neutral-800 bg-neutral-300 px-5 py-1.5 rounded">Dark</span>
                        <span class="badge text-sm font-semibold bg-transparent px-5 py-1.5 rounded text-primary-600">Link</span>
                        <span class="badge text-sm font-semibold bg-light-100 px-5 py-1.5 rounded text-secondary-light">Light</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="badge text-sm font-semibold rounded-full bg-light-600 px-5 py-1.5 text-dark">Light</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        <button type="button" class="badge text-sm font-semibold bg-primary-600 px-4 py-1.5 rounded text-white flex items-center gap-2">
                            Primary
                            <span class="badge text-neutral-900 bg-white w-5 h-5 flex items-center justify-center rounded text-xs">4</span>
                        </button>
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full text-primary-600 bg-primary-50">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full text-purple-600 bg-purple-50">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full text-success-600 bg-success-100">3</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full text-warning-600 bg-warning-100">4</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full text-danger-600 bg-danger-100">5</span>

                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-primary-600 text-primary-600">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-purple-600 text-purple-600">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-success-600 text-success-600">3</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-warning-600 text-warning-600">4</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-danger-600 text-danger-600">5</span>
            ...
            <div class="card h-full p-0 border-0 overflow-hidden">
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded text-primary-600 bg-primary-50">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded text-purple-600 bg-purple-50">2</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded text-success-600 bg-success-100">3</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded text-warning-600 bg-warning-100">4</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded text-danger-600 bg-danger-100">5</span>

                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-primary-600 text-primary-600">1</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-purple-600 text-purple-600">2</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-success-600 text-success-600">3</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-warning-600 text-warning-600">4</span>
                        <span class="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-danger-600 text-danger-600">5</span>
                ...
                <div class="card-body p-6">
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <button class="relative rounded-full flex justify-center items-center" type="button">
                            <iconify-icon icon="mage:email" class="text-neutral-600 text-[32px]"></iconify-icon>
                        ...
                        <button class="relative rounded-full flex justify-center items-center" type="button">
                            <iconify-icon icon="iconoir:bell" class="text-neutral-600 text-[32px]"></iconify-icon>
                            <span class="absolute top-0 -end-[8px] -translate-y-1/2 px-1 py-0.5 leading-[1] flex items-center justify-center badge rounded-full bg-danger-600 text-white">2</span>
                        </button>
                        <button class="relative rounded-full flex justify-center items-center" type="button">
                            <iconify-icon icon="iconoir:bell" class="text-neutral-600 text-[32px]"></iconify-icon>
