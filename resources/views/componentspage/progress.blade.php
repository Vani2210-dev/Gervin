                ...
                <div class="card-body p-6">
                    ...
                    <div class="flex items-center flex-col gap-6">
                        ...
                        <div class="w-full bg-success-600/10 rounded-full h-2">
                            <div class="bg-success-600 h-2 rounded-full" style="width: 35%"></div>
                        </div>

                        <div class="w-full bg-info-600/10 rounded-full h-2">
                            <div class="bg-info-600 h-2 rounded-full" style="width: 50%"></div>
                        </div>

                        <div class="w-full bg-warning-600/10 rounded-full h-2">
                            <div class="bg-warning-600 h-2 rounded-full" style="width: 75%"></div>
                        </div>

                        <div class="w-full bg-danger-600/10 rounded-full h-2">
                            <div class="bg-danger-600 h-2 rounded-full" style="width: 90%"></div>
                        </div>
                    </div>
                ...
                <div class="card-body p-6">
                    ...
                    <div class="flex items-center flex-col gap-6 position-relative">
                        <div class="w-full bg-primary-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-primary-600 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 20%"></div>
                        </div>

                        <div class="w-full bg-success-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-success-600 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 35%"></div>
                        </div>

                        <div class="w-full bg-info-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-info-600 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 50%"></div>
                        </div>

                        <div class="w-full bg-warning-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-warning-600 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 75%"></div>
                        </div>

                        <div class="w-full bg-danger-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-danger-600 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 90%"></div>
                        </div>
                    </div>
                ...
                <div class="card-body p-6">
                    ...
                    <div class="flex items-center flex-col gap-6 position-relative">
                        <div class="w-full bg-gradient-to-l to-primary-600/50 from-primary-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-l to-primary-700 from-primary-500 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 20%"></div>
                        </div>

                        <div class="w-full bg-gradient-to-l to-success-600/50 from-success-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-l to-success-700 from-success-500 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 35%"></div>
                        </div>

                        <div class="w-full bg-gradient-to-l to-info-600/50 from-info-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-l to-info-700 from-info-500 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 50%"></div>
                        </div>

                        <div class="w-full bg-gradient-to-l to-warning-600/50 from-warning-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-l to-warning-700 from-warning-500 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 75%"></div>
                        </div>

                        <div class="w-full bg-gradient-to-l to-danger-600/50 from-danger-600/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-l to-danger-700 from-danger-500 h-2 rounded-full animate-progress transition-all ease-out duration-1000" style="width: 90%"></div>
                        </div>
                    </div>
