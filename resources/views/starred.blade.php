            ...
            <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
                <div class="card h-full p-0 border-0">
                    <div class="card-body p-6">
                        <button type="button" class="btn bg-primary-600 hover:bg-primary-700 text-white text-sm btn-sm px-3 py-3 w-full rounded-lg flex items-center gap-2 mb-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        ...
                        <div class="mt-4">
                            <ul>
                                <li class="item-active mb-1.5">
                                    <a href="{{ route('email') }}" class="hover:bg-primary-50 group hover:text-neutral-900 px-2.5 py-2.5 w-full rounded-lg text-neutral-600 flex items-center">
                                ...
                                <li class="mb-1.5">
                                    <a href="{{ route('starred') }}" class="hover:bg-primary-50 group hover:text-neutral-900 px-2.5 py-2.5 w-full rounded-lg text-neutral-600 flex items-center">
                                        <span class="flex items-center gap-2.5 justify-between w-full">
                                            <span class="flex items-center gap-2.5">
                            ...
                            <div class="mt-6">
                                <h6 class="text-lg font-semibold text-neutral-600 mb-4">TAGS</h6>
                                <ul>
                                    <li class="mb-5">
                ...
                <div class="card h-full p-0 border-0 email-card">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center gap-3">
                                <div class="form-check style-check flex items-center">
                                    <input class="form-check-input rounded border bg-white" type="checkbox" name="checkbox" id="selectAll">
                                    <div class="">
                                        ...
                                        <div id="dropdownArrowDown" class="sm:min-w-max z-10 hidden border border-transparent bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44">
                                            <ul class="rounded-lg bg-white shadow p-4 text-sm text-gray-700">
                                                <li>
                                                    <button type="button" class="px-4 py-2 rounded text-neutral-600 hover:bg-neutral-200 block w-full text-start text-hover-neutral-900" data-bs-toggle="modal" data-bs-target="#exampleModalView">
                                                        All
                                                    </button>
                                                </li>
                                                <li>
                                                    <button type="button" class="px-4 py-2 rounded text-neutral-600 hover:bg-neutral-200 block w-full text-start text-hover-neutral-900" data-bs-toggle="modal" data-bs-target="#exampleModalEdit">
                                                        None
                                                    </button>
                                                </li>
                                                <li>
                                ...
                                <div class="">
                                    ...
                                    <div id="dropdownThreeDots" class="sm:min-w-max z-10 hidden border border-transparent bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44">
                                        <ul class="p-4 text-sm text-gray-700">
                                            <li>
                                                <button type="button" class="dropdown-item px-4 py-2 rounded text-secondary-light hover:bg-neutral-200 text-hover-neutral-900 flex items-center text-start gap-2.5" data-bs-toggle="modal" data-bs-target="#exampleModalView">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination flex">
                                        <li class="page-item">
                                            <a class="page-link flex bg-white border text-secondary-light text-xl" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-left-2" class="icon"></iconify-icon> </a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link flex bg-white border text-secondary-light text-xl" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-right-2" class="icon"></iconify-icon> </a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <ul class="overflow-x-auto">
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                <div class="form-check style-check flex items-center">
                                    <input class="form-check-input rounded border border-neutral-400 bg-white" type="checkbox" name="checkbox">
                                </div>
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Jerome Bell</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                <div class="form-check style-check flex items-center">
                                    <input class="form-check-input rounded border border-neutral-400 bg-white" type="checkbox" name="checkbox">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Kristin Watson</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Cody Fisher</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Dianne Russell</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Floyd Miles</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Devon Lane</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                            ...
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Annette Black</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Bessie Cooper</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Courtney Henry</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                            <li class="email-item px-6 py-4 flex gap-4 items-center border-b last:border-0 border-neutral-200 cursor-pointer hover:bg-neutral-200 min-w-max">
                                ...
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium text-base text-line-1 w-[190px]">Wade Warren</a>
                                <a href="{{ route('veiwDetails') }}" class="text-neutral-600 font-medium mb-0 line-clamp-1 max-w-[740px]">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                <span class="text-neutral-600 font-medium min-w-max-content ms-auto">6:07 AM</span>
                            </li>
                        </ul>
