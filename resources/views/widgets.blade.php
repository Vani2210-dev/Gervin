    ...
    <div class="card h-full p-0 rounded-xl border-0 overflow-hidden">
        ...
        <div class="card-body p-6 flex flex-col gap-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
                ...
                <div class="card shadow-none border border-gray-200 rounded-lg h-full bg-gradient-to-r from-purple-600/10 to-bg-white">
                    <div class="card-body p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p class="font-medium text-neutral-900 mb-1">Total Subscription</p>
                ...
                <div class="card shadow-none border border-gray-200 rounded-lg h-full bg-gradient-to-r from-blue-600/10 to-bg-white">
                    <div class="card-body p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p class="font-medium text-neutral-900 mb-1">Total Free Users</p>
                ...
                <div class="card shadow-none border border-gray-200 rounded-lg h-full bg-gradient-to-r from-success-600/10 to-bg-white">
                    <div class="card-body p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p class="font-medium text-neutral-900 mb-1">Total Income</p>
                ...
                <div class="card shadow-none border border-gray-200 rounded-lg h-full bg-gradient-to-r from-red-600/10 to-bg-white">
                    <div class="card-body p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p class="font-medium text-neutral-900 mb-1">Total Expense</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border border-neutral-200">
                ...
                <div class="card-body p-6 h-full flex flex-col lg:border-r border-r-0 border-neutral-200 last:border-r-0 border-b lg:border-b-0">
                    <div class="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                        <div>
                ...
                <div class="card-body p-6 h-full flex flex-col sm:border-r border-r-0 border-neutral-200 last:border-r-0 border-b sm:border-b-0">
                    <div class="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                        <div>
                ...
                <div class="card-body p-6 h-full flex flex-col sm:border-r border-r-0 border-neutral-200 last:border-r-0">
                    <div class="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                        <div>
            ...
            <div class="card h-full border-0">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div id="world-map" class="h-full border border-neutral-200 rounded-lg"></div>
                        <div class="h-full border border-neutral-200 p-4 pe-0 rounded-lg">
