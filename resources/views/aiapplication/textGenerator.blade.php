            ...
            <div class="card p-0 border-0">
                <div class="card-body p-0">
                    ...
                    <ul class="ai-chat-list scroll-sm px-6 pb-6 max-h-[644px] overflow-y-auto">
                        ...
                        <li class="mb-4">
                            <a href="text-generator.html" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">UI/UX Design Roadmap write me the roadmap right now </a>
                        </li>
                        <li class="mb-4">
                            <a href="text-generator.html" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        <li class="mb-4">
                            <a href="text-generator.html" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-4">
                            <a href="text-generator.html" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">Online School Education Learning</a>
                        </li>
                        <li class="mb-4">
                            <a href="text-generator.html" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-0">
                            <a href="" class="line-clamp-1 text-neutral-600 hover:text-primary-600 text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                    </ul>
            ...
            <div class="chat-600 card overflow-hidden border-0">
                <div class="chat-sidebar-single gap-2 flex items-center px-6 py-5 justify-between cursor-default flex-nowrap">
                    <div class="flex items-center gap-4">
                        <a href="text-generator-new.html" class="text-neutral-600 text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
                ...
                <div class="chat-message-list px-6 py-5 max-h-[612px] min-h-[612px] overflow-y-auto">
                    ...
                    <div class="flex items-start justify-between gap-4 border-b border-neutral-200 pb-4 mb-4">
                        <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-start gap-4 border-b border-neutral-200 pb-4 mb-4">
                        ...
                        <div class="info grow">
                            ...
                            <p class="font-semibold text-neutral-600 my-4">1. Research and Discovery</p>
                            <p class="text-neutral-600 my-4">a. Understand the Business Goals</p>

                            <ul class="list-style">
                                <li class="text-neutral-600 m-0"> <span class="font-semibold text-neutral-600">Kickoff Meeting:</span> Meet with stakeholders to understand the business objectives, target audience, and project scope.</li>
                                <li class="text-neutral-600 m-0"> <span class="font-semibold text-neutral-600">Kickoff Meeting:</span> Meet with stakeholders to understand the business objectives, target audience, and project scope.</li>
                            </ul>
                ...
                <form class="chat-message-box border-t border-neutral-200 flex items-center gap-4 p-6">
                    <input type="text" class="w-full border-0 focus:ring-0 bg-transparent px-0" name="chatMessage" placeholder="Message wowdash...">
