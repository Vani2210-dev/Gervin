        ...
        <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
            <div class="card h-full p-0 border-0">
                <div class="card-body p-6">
                    <div class="mb-5">
                        <label for="Title" class="text-sm font-semibold text-neutral-600 mb-2 inline-block">Title</label>
                        <input type="text" class="form-control px-4 py-3.5 h-12" id="Title" placeholder="Enter Title">
                    </div>
                    <div class="mb-5">
                        <label for="Voice" class="text-sm font-semibold text-neutral-600 mb-2 inline-block">Language</label>
                    ...
                    <div class="mb-5">
                        <label for="Desc" class="text-sm font-semibold text-neutral-600 mb-2 inline-block">Desc</label>
                        <textarea class="form-control px-4 py-3.5 " id="Desc" placeholder="Write something... "></textarea>
                    </div>
                    <div class="mb-5">
                        <label class="text-sm font-semibold text-neutral-600 mb-2 inline-block">Upload Avatar</label>
