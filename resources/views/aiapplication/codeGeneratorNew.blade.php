        ...
        <div class="col-xxl-3 col-lg-4">
            <div class="card h-full p-0">
                <div class="card-body p-0">
                    <div class="p-6">
                        <a href="{{ route('codeGeneratorNew') }}" class="btn btn-primary text-sm btn-sm px-3 py-3 w-full rounded-lg flex items-center justify-center gap-2">
                    ...
                    <ul class="ai-chat-list scroll-sm pe-6 ps-1.5 pb-6">
                        ...
                        <li class="mb-4">
                            <a href="{{ route('codeGenerator') }}" class="text-line-1 text-secondary-light text-hover-primary-600">Please create a 5 Column table with HTML Css and js </a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('codeGenerator') }}" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('codeGenerator') }}" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-4">
                            <a href="{{ route('codeGenerator') }}" class="text-line-1 text-secondary-light text-hover-primary-600">Online School Education Learning</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('codeGenerator') }}" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
            ...
            <div class="chat-600 card overflow-hidden">
                ...
                <div class="chat-message-list max-h-[612px] min-h-[612px] relative">
                    <div class="flex items-center justify-center flex-col h-full absolute top-1/2 start-1/2 translate-middle">
                        <img src="{{ asset('assets/images/chatgpt/empty-message-icon2.png') }}" alt="">
