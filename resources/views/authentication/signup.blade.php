            ...
            <div class="lg:max-w-[464px] mx-auto w-full">
                ...
                <form action="#">
                    <div class="icon-field mb-4 relative">
                        ...
                        <input type="text" class="form-control h-[56px] ps-11 border-neutral-300 bg-neutral-50 rounded-xl" placeholder="Username">
                    </div>
                    <div class="icon-field mb-4 relative">
                        <span class="absolute start-4 top-1/2 -translate-y-1/2 pointer-events-none flex text-xl">
                    ...
                    <div class="mb-5">
                        <div class="relative">
                            <div class="icon-field">
                                ...
                                <input type="password" class="form-control h-[56px] ps-11 border-neutral-300 bg-neutral-50 rounded-xl" id="your-password" placeholder="Password">
                            </div>
                    ...
                    <div class="mt-8 center-border-horizontal text-center relative before:absolute before:w-full before:h-[1px] before:top-1/2 before:-translate-y-1/2 before:bg-neutral-300 before:start-0">
                        <span class="bg-white z-[2] relative px-4">Or sign up with</span>
                    </div>
                    <div class="mt-8 flex items-center gap-3">
                        <button type="button" class="font-semibold text-neutral-600 py-4 px-6 w-1/2 border rounded-xl text-base flex items-center justify-center gap-3 line-height-1 hover:bg-primary-50">
