...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
        ...
        <div class="card shadow-none border-gray-200 bg-gradient-to-l from-blue-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="card shadow-none border-gray-200 bg-gradient-to-l from-purple-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="card shadow-none border-gray-200 bg-gradient-to-l from-primary-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                ...
                                <p class="text-sm mb-0 flex items-center gap-1">
                                    Bitcoin (BTC)
                                    <span class="bg-success-100 border border-success-600/25 px-2 py-2 rounded-full font-semibold text-success-600 text-sm inline-flex items-center gap-1">
                                        10%
                    ...
                    <div class="card h-full rounded-lg border-0">
                        <div class="card-body p-6">
                            <div class="flex items-center flex-wrap gap-2 justify-between mb-5">
                                <h6 class="mb-2 font-bold text-lg">Coin Analytics</h6>
                                <div class="border border-neutral-200 rounded px-4 py-2 pe-0 flex items-center gap-1 text-sm text-secondary-light">
                                    Currency:
                                    <select class="form-select form-select-sm text-neutral-700 w-auto bg-white border-0 font-semibold">
                                        <option>USD</option>
                                        <option>BDT</option>
                                        <option>RUP</option>
                                    </select>
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 px-2 py-2 rounded mb-4">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 px-2 py-1.5 rounded">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('assets/images/currency/crypto-img1.png') }}" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                                ...
                                <table class="table bordered-table mb-0 xsm-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <span class="text-success-600 bg-success-100 w-8 h-8 flex items-center justify-center rounded-full text-xl">
                                            ...
                                            <td>
                                                <span class="text-neutral-600 block font-medium">10:34 AM</span>
                                                <span class="text-secondary-light text-sm">27 Mar 2025</span>
                                            </td>
                                            <td>
                                                <span class="text-neutral-600 block font-medium">+ 0.431 BTC</span>
                                                <span class="text-secondary-light text-sm">$3,480.90</span>
                                            </td>
                                            <td>Abc.........np562</td>
                                            <td class="text-center">
                                                <span class="bg-success-100 text-success-600 px-4 py-1.5 rounded font-medium text-sm">Completed</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <span class="text-danger-600 bg-danger-100 w-8 h-8 flex items-center justify-center rounded-full text-xl">
                                            ...
                                            <td>Abc.........np562</td>
                                            <td class="text-center">
                                                <span class="bg-danger-100 text-danger-600 px-4 py-1.5 rounded font-medium text-sm">Terminated</span>
                                            </td>
                                        </tr>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="card h-full border-0">
                    <div class="card-body p-6">
                        ...
                        <div class="tab-style-button mb-6 mt-7 border border-neutral-200 input-form-light p-1 rounded-lg bg-neutral-50">
                            <ul class="grid grid-cols-2 -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                                ...
                                <li role="presentation">
                                    <button class="px-3 py-2.5 text-base w-full text-center rounded-lg hover:text-gray-600 hover:border-gray-300" id="sell-tab" data-tabs-target="#sell" type="button" role="tab" aria-controls="sell" aria-selected="false">Sell</button>
                                </li>
                            </ul>
                        </div>

                        <div id="default-tab-content">
                            <div class="hidden p-4 rounded-lg bg-gray-50" id="buy" role="tabpanel" aria-labelledby="buy-tab">
                                <div class="">
                                    <div class="mb-5">
                                        <label for="estimatedValue" class="font-semibold mb-2 block text-neutral-600">Estimated Purchase Value</label>
                                        <div class="flex justify-content-between border border-neutral-200 rounded-lg">
                                            ...
                                            <div class="shrink-0 bg-neutral-50 rounded-tr-lg rounded-br-lg border-0 font-normal ps-1 pe-1 flex justify-center items-center">
                                                <select class="form-select form-select-sm w-auto bg-transparent font-bolder border-0 text-secondary-light">
                                                    <option class="bg-white">BTC</option>
                                                    <option class="bg-white">LTC</option>
                                                    <option class="bg-white">ETC</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-5">
                                        <label for="tradeValue" class="font-semibold mb-2 block text-neutral-600">Trade Value</label>
                                        <div class="flex justify-content-between border border-neutral-200 rounded-lg">
                                            ...
                                            <div class="shrink-0 bg-neutral-50 rounded-tr-lg rounded-br-lg border-0 font-normal ps-1 pe-1 flex justify-center items-center">
                                                <select class="form-select form-select-sm w-auto bg-transparent font-bolder border-0 text-secondary-light">
                                                    <option class="bg-white">USD</option>
                                                    <option class="bg-white">BTC</option>
                                                    <option class="bg-white">LTC</option>
                                                    <option class="bg-white">ETC</option>
                                                </select>
                                    ...
                                    <div class="mb-6">
                                        <span class="mb-1.5 text-sm text-secondary-light">Total Balance</span>
                                        <h6 class="mb-1.5 font-semibold text-xl text-warning-600">$320,320.00</h6>
                                    </div>
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50" id="sell" role="tabpanel" aria-labelledby="sell-tab">
                                <div class="">
                                    <div class="mb-5">
                                        <label for="estimatedValueTwo" class="font-semibold mb-2 block text-neutral-600">Estimated Purchase Sell Value</label>
                                        <div class="flex justify-content-between border border-neutral-200 rounded-lg">
                                            <input type="text" class="grow w-full rounded-tl-lg rounded-bl-lg  form-control bg-white border-0" id="estimatedValueTwo" placeholder="Estimated Value">
                                            <div class="shrink-0 bg-neutral-50 rounded-tr-lg rounded-br-lg border-0 font-normal ps-1 pe-1">
                                                <select class="form-select form-select-sm w-auto bg-transparent font-bolder border-0 text-secondary-light">
                                                    <option class="bg-white">BTC</option>
                                                    <option class="bg-white">LTC</option>
                                                    <option class="bg-white">ETC</option>
                                    ...
                                    <div class="mb-5">
                                        <label for="tradeValueTwo" class="font-semibold mb-2 block text-neutral-600">Trade Value</label>
                                        <div class="flex justify-content-between border border-neutral-200 rounded-lg">
                                            <input type="text" class="grow w-full rounded-tl-lg rounded-bl-lg  form-control bg-white border-0" id="tradeValueTwo" placeholder="Trade Value">
                                            <div class="shrink-0 bg-neutral-50 rounded-tr-lg rounded-br-lg border-0 font-normal ps-1 pe-1">
                                                <select class="form-select form-select-sm w-auto bg-transparent font-bolder border-0 text-secondary-light">
                                                    <option class="bg-white">USD</option>
                                                    <option class="bg-white">BTC</option>
                                    ...
                                    <div class="mb-5">
                                        <label class="font-semibold mb-2 block text-neutral-600">Address</label>
                                        <textarea class="form-control w-full bg-white border border-neutral-200 h-[80px] rounded-lg" placeholder="Enter Address"></textarea>
                                    </div>
                                    <div class="mb-6">
                                        <span class="mb-1.5 text-sm text-secondary-light">Total Balance</span>
                                        <h6 class="mb-1.5 font-semibold text-xl text-warning-600">$320,320.00</h6>
                ...
                <div class="card h-full rounded-lg border-0">
                    <div class="card-body p-6">
                        ...
                        <div class="relative">
                            <span class="w-[80px] h-[80px] bg-white shadow-xl text-neutral-600 font-semibold text-xl flex justify-center items-center rounded-full absolute end-0 top-0 z-1">+30%</span>
                            <div id="statisticsDonutChart" class="mt-9 grow apexcharts-tooltip-z-none title-style circle-none"></div>
                            <span class="w-[80px] h-[80px] bg-white shadow-xl text-neutral-600 font-semibold text-xl flex justify-center items-center rounded-full absolute start-0 bottom-0 z-1">+25%</span>
                        </div>
