...
@section('content')
    ...
    {{-- Phân xưởng sản xuất --}}
    @canany(['view pressing', 'view cnc', 'view edge banding', 'view finishing', 'view qc', 'view packing', 'view dispatch', 'view delivery'])
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-4">
            ...
            {{-- Dispatch --}}
            @can('view dispatch')
            <a href="{{ route('processes.dispatch') }}" class="card border border-neutral-200 rounded-xl hover:border-indigo-500 hover:shadow-md transition-all duration-300 bg-white">
                <div class="card-body p-4 flex flex-col items-center justify-center text-center h-full">
                    ...
                    <span class="text-xs text-neutral-400">Xuất xưởng sản phẩm</span>
                </div>
            </a>
            @endcan
            ...
            {{-- Delivery --}}
            @can('view delivery')
            <a href="{{ route('processes.delivery') }}" class="card border border-neutral-200 rounded-xl hover:border-emerald-500 hover:shadow-md transition-all duration-300 bg-white">
                <div class="card-body p-4 flex flex-col items-center justify-center text-center h-full">
                    <div class="w-12 h-12 bg-emerald-100 text-emerald-600 rounded-xl flex justify-center items-center mb-3">
                        <iconify-icon icon="lucide:navigation" class="text-2xl"></iconify-icon>
                    </div>
                    <h6 class="text-sm font-semibold text-neutral-800 mb-1">Giao hàng</h6>
                    <span class="text-xs text-neutral-400">Kiểm tra & Giao hàng</span>
                </div>
            </a>
            @endcan
        </div>
