                ...
                <div class="card-body p-6">
                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Bitcoin</span>
                                    ...
                                    <td>$2,753.00</td>
                                    <td>
                                        <span class="bg-success-100 text-success-600 px-4 py-1.5 rounded-full font-semibold text-xs">
                                            <i class="ri-arrow-up-s-fill"></i>
                                            1.37%
                                        </span>
                                    </td>
                                    <td>
                                        <div class="w-full max-w-[150px] bg-gray-200 rounded-full h-2.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Ethereum</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Litecoin</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Binance</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Dogecoin</span>
                                    ...
                                    <td>$2,753.00</td>
                                    <td>
                                        <span class="bg-danger-100 text-danger-600 px-4 py-1.5 rounded-full font-semibold text-xs">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            ...
                                            <div class="grow flex flex-col">
                                                <span class="text-base mb-0 font-medium text-neutral-600 block">Polygon </span>
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-2 mt-6">
                        ...
                        <ul class="pagination flex flex-wrap items-center gap-2 justify-center">
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8 text-base" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class=""></iconify-icon></a>
                            </li>
                            <li class="page-item">
                            ...
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8" href="javascript:void(0)">2</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8 text-base" href="javascript:void(0)">3</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8 text-base" href="javascript:void(0)">4</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8 text-base" href="javascript:void(0)">5</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link bg-primary-50 text-secondary-light font-medium rounded border-0 px-2.5 py-2.5 flex items-center justify-center h-8 w-8 text-base" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class=""></iconify-icon> </a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card h-full border-0">
                <div class="card-body p-0">
                    <div class="px-6 py-5">
                        ...
                        <div class="mt-6 pb-6 mb-6 border-b border-neutral-200 flex items-center gap-4 justify-between flex-wrap">
                            <div class="text-center flex items-center  flex-col">
                                <span class="w-[60px] h-[60px] bg-primary-100 text-primary-600 text-2xl inline-flex justify-center items-center rounded-full ">
                                    <i class="ri-add-line"></i>
                                </span>
                                <span class="text-neutral-600 font-medium mt-6">Buy</span>
                            </div>
                            <div class="text-center flex items-center  flex-col">
                                <span class="w-[60px] h-[60px] bg-primary-100 text-primary-600 text-2xl inline-flex justify-center items-center rounded-full ">
                                    <i class="ri-arrow-left-right-line"></i>
                                </span>
                                <span class="text-neutral-600 font-medium mt-6">Swap</span>
                            </div>
                            <div class="text-center flex items-center  flex-col">
                                <span class="w-[60px] h-[60px] bg-primary-100 text-primary-600 text-2xl inline-flex justify-center items-center rounded-full ">
                                    <i class="ri-upload-2-line"></i>
                                </span>
                                <span class="text-neutral-600 font-medium mt-6">Send</span>
                            </div>
                            <div class="text-center flex items-center  flex-col">
                                <span class="w-[60px] h-[60px] bg-primary-100 text-primary-600 text-2xl inline-flex justify-center items-center rounded-full ">
                                    <i class="ri-download-2-line"></i>
                                </span>
                                <span class="text-neutral-600 font-medium mt-6">Receive</span>
                            </div>
                        </div>

                        <div class="flex items-center justify-between gap-2 pb-6 border-b border-neutral-200">
                            <h6 class="text-lg mb-0">Watchlist</h6>
                            <a href="javascript:void(0)" class="text-primary-600 font-medium text-base">Sell all</a>
                        </div>

                        <div class="flex items-center justify-between flex-wrap gap-2 py-4 border-b border-neutral-200">
                            <div class="flex items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img1.png') }}" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow flex flex-col">
                                    <span class="text-base mb-0 font-medium text-neutral-600 block">Bitcoin</span>
                            ...
                            <div class=" flex flex-col">
                                <span class="text-base mb-0 font-medium text-neutral-600 block">$1,236.21</span>
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-2 py-4 border-b border-neutral-200">
                            ...
                            <div class=" flex flex-col">
                                <span class="text-base mb-0 font-medium text-neutral-600 block">$1,658</span>
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-2 py-4">
                            <div class="flex items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img6.png') }}" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow flex flex-col">
                                    <span class="text-base mb-0 font-medium text-neutral-600 block">Digibyte</span>
                                    <span class="text-xs mb-0 font-normal text-secondary-light">DGB</span>
                                </div>
                            </div>
                            <div class=" flex flex-col">
                                <span class="text-base mb-0 font-medium text-neutral-600 block">$165,8</span>
    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                <!-- Modal header -->
                <div class="flex items-center justify-between px-6 py-3 border-b rounded-t">
                ...
                <div class="flex flex-col gap-2 p-6">
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 rounded-lg hover:bg-neutral-50">
                    ...
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 rounded-lg hover:bg-neutral-50">
                        <span class="flex items-center gap-4">
                            ...
                            <span class="text-base mb-0 font-medium text-neutral-600 block">Coinbase Wallet</span>
                        </span>
                        <span class="text-secondary-light text-base"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 rounded-lg hover:bg-neutral-50">
                        <span class="flex items-center gap-4">
                            ...
                            <span class="text-base mb-0 font-medium text-neutral-600 block">Exodus Wallet</span>
                        </span>
                        <span class="text-secondary-light text-base"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 rounded-lg hover:bg-neutral-50">
                        <span class="flex items-center gap-4">
                            ...
                            <span class="text-base mb-0 font-medium text-neutral-600 block">Trust Wallet</span>
                        </span>
                        <span class="text-secondary-light text-base"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
