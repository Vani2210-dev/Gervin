        ...
        <div class="card-body p-10">
            <form action="#">
                <div class="grid md:grid-cols-2 gap-x-5">
                    <div class="mb-5">
                        <label for="firebaseSecretKey" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase secret key</label>
                    ...
                    <div class="mb-5">
                        <label for="firebasePublicVapidKey" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase public vapid key (key pair)</label>
                    ...
                    <div class="mb-5">
                        <label for="firebaseAPIKey" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase  API Key</label>
                    ...
                    <div class="mb-5">
                        <label for="firebaseAuthDomain" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase  AUTH Domain</label>
                    ...
                    <div class="mb-5">
                        <label for="firebaseProjectID" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase Project ID</label>
                        <input type="text" class="form-control rounded-lg" id="firebaseProjectID" placeholder="Firebase Project ID" value="wowdash.com">
                    </div>
                    <div class="mb-5">
                        <label for="firebaseStorageBucket" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase Storage Bucket</label>
                    ...
                    <div class="mb-5">
                        <label for="firebaseMessageSenderID" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase  Message Sender ID</label>
                    ...
                    <div class="mb-5">
                        <label for="firebaseAppID" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase  App ID</label>
                    ...
                    <div class="mb-5 col-span-2">
                        <label for="firebaseMeasurmentID" class="text-sm font-semibold mb-2 block text-neutral-900">Firebase  Measurement ID</label>
