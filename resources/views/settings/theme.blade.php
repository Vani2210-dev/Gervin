        ...
        <div class="card-body p-6">
            <form action="#">
                <div class="grid md:grid-cols-2 gap-x-5">
                    <div class="mb-5">
                        <label class="inline-block font-semibold text-secondary-light text-base inline-block mb-2" for="imageUpload">Logo (140px X 140px)</label>
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="imageUpload" type="file">
                    ...
                    <div class="mb-5">
                        <label class="inline-block font-semibold text-secondary-light text-base inline-block mb-2" for="imageUploadTwo">Logo (140px X 140px)</label>
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="imageUploadTwo" type="file">
                ...
                <div class="mt-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-12 gap-5">
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="blue" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                        ...
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="magenta" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                                <span class="flex items-center gap-2">
                                    <span class="w-1/2 text-center">
                                    ...
                                    <span class="w-1/2 text-center">
                                        <span class="h-[72px] w-full bg-purple-600 text-purple-600 rounded"></span>
                                        <span class="text-secondary-light text-base font-semibold mt-2">Focus</span>
                                    </span>
                                </span>
                            </label>
                        ...
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="orange" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                                <span class="flex items-center gap-2">
                                    <span class="w-1/2 text-center">
                        ...
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="green" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                                <span class="flex items-center gap-2">
                                    <span class="w-1/2 text-center">
                        ...
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="red" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                                <span class="flex items-center gap-2">
                                    <span class="w-1/2 text-center">
                        ...
                        <div class="2xl:col-span-2 md:col-span-4 sm:col-span-6 col-span-12 relative">
                            ...
                            <label for="blueDark" class="theme-setting-label border border-neutral-200 rounded-lg p-2 block">
                                <span class="flex items-center gap-2">
                                    <span class="w-1/2 text-center">
