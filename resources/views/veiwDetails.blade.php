                    ...
                    <div class="">
                        <div class="card-header border-b border-neutral-200 bg-white py-4 px-6 flex items-center gap-3 justify-between flex-wrap">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="bg-primary-100 text-primary-600 text-sm rounded px-2">Personal</span>
                            </div>
                            ...
                            <div class="py-4 px-6 border-b border-neutral-200">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="mt-5">
                                            <p class="mb-4 text-neutral-600">Hi William</p>
                                            <p class="mb-4 text-neutral-600">Just confirming that we transferred $63.86 to you via PayPal <a href="javascript:void(0)" class="text-primary-600 underline">(info367@gmail.com)</a> which you earned on the themewow Market since your last payout.</p>
                                            <p class="mb-0 text-neutral-600">Thank you for selling with us!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="py-4 px-6 border-b border-neutral-200">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="mt-5">
                                            <p class="mb-0 text-neutral-600">Awesome, thank you so much!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
