                ...
                <div class="overflow-x-auto pb-3" data-order-supplies-table-scroll>
                    ...
                    <table class="table bordered-table sm-table mb-0 min-w-[1100px] border border-neutral-200">
                        <thead>
                            ...
                            <tr class="bg-neutral-50 text-center">
                                <th scope="col" style="width: 130px; min-width: 130px; white-space: nowrap;" class="border border-neutral-200 bg-yellow-100/70 font-semibold text-xs text-neutral-700 uppercase text-center order-header-force-center">Cao (chiều vân)</th>
                                <th scope="col" style="width: 130px; min-width: 130px; white-space: nowrap;" class="border border-neutral-200 font-semibold text-xs text-neutral-700 uppercase text-center">Rộng</th>
                            </tr>
                        </thead>
