        ...
        <div class="card-body p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-4 gap-6">
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            ...
                            <div class="center-border relative bg-gradient-to-r from-danger-500/10 to-danger-50/25 rounded-lg p-3 flex items-center gap-4 before:absolute before:w-px before:h-full before:z-[1] before:bg-neutral-200 before:start-1/2">
                            ...
                            <a href="{{ route('viewProfile') }}" class="bg-primary-50 hover:bg-primary-600 hover:text-white text-primary-600 bg-hover-primary-600 hover-text-white p-2.5 text-sm btn-sm px-3 py-3 rounded-lg flex items-center justify-center mt-4 font-medium gap-2 w-full">
                                View Profile
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown4" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown5" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown6" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown7" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown8" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown9" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown10" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown11" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="dropdown absolute top-0 end-0 me-4 mt-4">
                            ...
                            <div id="dropdown12" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-neutral-100 w-44">
                                <ul class="p-2 text-sm text-gray-700">
                                    <li>
                                        <button type="submit" class="w-full text-start px-4 py-2.5 hover:bg-gray-100 rounded flex items-center gap-2">
                                            Edit
